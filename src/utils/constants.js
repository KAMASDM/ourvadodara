...
export const CATEGORIES = [
  ...
  { id: 'india', name: { en: 'India', hi: 'भारत', gu: 'ભારત' }, icon: '🇮🇳' },
  { id: 'world', name: { en: 'World', hi: 'विश्व', gu: 'વિશ્વ' }, icon: '🌍' },
  { id: 'science', name: { en: 'Science', hi: 'विज्ञान', gu: 'વિજ્ઞાન' }, icon: '🔬' },
  { id: 'space', name: { en: 'Space', hi: 'अंतरिक्ष', gu: 'અવકાશ' }, icon: '🚀' },
  { id: 'health', name: { en: 'Health', hi: 'स्वास्थ्य', gu: 'આરોગ્ય' }, icon: '🏥' },
];
