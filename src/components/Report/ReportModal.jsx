...
const ReportModal = ({ isOpen, onClose, contentId, contentTitle = '', contentType = 'post' }) => {
  ...
  return createPortal(
    <div className="app-modal-layer flex items-center justify-center bg-black bg-opacity-50" onClick={onClose} role="presentation">
      <div className="app-modal-panel bg-white dark:bg-gray-800 rounded-lg max-w-md w-full" onClick={(event) => event.stopPropagation()} role="dialog" aria-modal="true" aria-labelledby="report-dialog-title">
